...
{
    public partial class BookManagementTryContext : DbContext
    {
        public BookManagementTryContext()
        {
        }
        ...
        public BookManagementTryContext(DbContextOptions<BookManagementTryContext> options)
            : base(options)
        {
        }
